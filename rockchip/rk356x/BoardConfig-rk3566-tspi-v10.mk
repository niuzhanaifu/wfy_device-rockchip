...
# Extra partitions (oem + userdata + blackbox)
export RK_EXTRA_PARTITIONS="oem:/oem:ext2:defaults:oem_normal:auto@userdata:/userdata:ext2:defaults:userdata_normal:auto@blackbox:/blackbox:ext2:defaults:blackbox:512M"
